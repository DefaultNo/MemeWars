(() => {
    ...
    function initSliders() {
        ...
        document.querySelector(".home__current-number").textContent = `1`;
        document.querySelector(".home__all-number").textContent = `${slideCount}`;
        if (document.querySelector(".home__body")) {
            let secondSwiper = new core(".slide-home__bottom", {
                ...
                spaceBetween: 27,
                navigation: {
                    prevEl: ".slide-home__button-prev",
                    nextEl: ".slide-home__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 3,
            ...
            const swiper = new core(".home__body", {
                ...
                on: {
                    slideChange: () => {
                        document.querySelector(".home__current-number").textContent = `${swiper.realIndex + 1}`;
                        document.querySelector(".home__all-number").textContent = slideCount;
                    }
                }
            });
        }
        if (document.querySelector(".block-download__videos")) {
            new core(".block-download__videos", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
                ...
                spaceBetween: 50,
                pagination: {
                    el: ".videos-download__pagination",
                    clickable: true,
                    type: "bullets"
                }
            });
        }
        if (document.querySelector(".contests__body")) {
            new core(".contests__body", {
                ...
                spaceBetween: 14,
                pagination: {
                    el: ".contests__pagination",
                    clickable: true,
                    type: "bullets"
                },
                navigation: {
                    prevEl: ".contests__arrow-prev",
                    nextEl: ".contests__arrow-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        if (document.querySelector(".patch__body")) new core(".patch__body", {
            modules: [ Pagination, Navigation ],
            observer: true,
            observeParents: true,
            speed: 800,
            ...
            spaceBetween: 100,
            pagination: {
                el: ".patch__pagination",
                clickable: true,
                type: "bullets"
            },
            navigation: {
                prevEl: ".patch__arrow-prev",
                nextEl: ".patch__arrow-next"
            }
        });
    }
    ...
    if (video.length) video.forEach((item => {
        ...
        item.addEventListener("click", (() => {
            ...
            item.insertAdjacentHTML("afterbegin", `<iframe  src="${src}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`);
        }));
    }));
    const headerBurger = document.querySelector(".header__burger"), headerMenu = document.querySelector(".header__menu");
